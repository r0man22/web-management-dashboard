...
<html lang="en">
	...
	<body>
						...
						<div class="col-xl-9 col-lg-8  col-md-12">
							<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm grow bg-white card">
									...
									<ul class="list-group list-group-horizontal-lg">
											<li class="list-group-item text-center active button-5"><a href="reports.php" class="text-white">Forma 1 hesabat</a></li>
											<li class="list-group-item text-center button-6"><a class="text-dark" href="reports2.php">Forma 2 hesabat</a></li>
								...
								<div class="card shadow-sm ctm-border-radius grow">
									<div class="card-body align-center">
										<div class="row filter-row">
											...
											<form method="post">
            <label for="month" class="form-control">Tarix seç:</label>
            <input type="month" class="form-control" name="month" id="month" value="<?= htmlspecialchars($selected_month) ?>" required>
									...
									<div class="card-body align-center">
										<ul class="nav flex-row nav-pills" id="pills-tab" role="tablist" >
											<li class="nav-item mr-2">
												<a class="nav-link active mb-2" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Şöbələrin Qiymətləndirilməsi</a>
											</li>
        ...
        <!-- <h2>Оценки департаментов</h2> -->
		<table id="reports-2" class="table-responsive">
            <thead>
                <tr>
                    <th>Şöbənin Adı</th>
                    <th>Ay</th>
                    ...
                    <th>Hesabatlıq</th>
                    <th>Ümumi Aylıq Qiymət</th>
                </tr>
            </thead>
            <tbody>
                <?php if (empty($department_reports)): ?>
                    <tr>
                        <td colspan="13">Нет данных для выбранного месяца.</td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($department_reports as $department): ?>
                        <tr>
                            <td><?= htmlspecialchars($department['name']) ?></td>
                            <td><?= htmlspecialchars($department['month']) ?></td>
                            <td><?= $department['score_1'] ?></td>
                            <td><?= $department['score_2'] ?></td>
                            <td><?= $department['score_3'] ?></td>
                            <td><?= $department['score_4'] ?></td>
                            <td><?= $department['score_5'] ?></td>
                            <td><?= $department['score_6'] ?></td>
                            <td><?= $department['score_7'] ?></td>
                            <td><?= $department['total_score'] ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
